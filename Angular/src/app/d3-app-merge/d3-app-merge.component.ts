...
@Component({
  selector: 'app-d3-app-merge',
  templateUrl: './d3-app-merge.component.html',
  styleUrls: ['./d3-app-merge.component.css'],
  encapsulation:ViewEncapsulation.None
})
export class D3AppMergeComponent implements OnInit {

 

  ngOnInit() {
    console.log('D3.js version:', d3['version']);
    d3.select("svg").style("background-color","#edebed");
    d3.select("body").style("background-color", "#edebed");
    d3.select("svg").style("background-color","#edebed");
    ...
    const simulation = d3.forceSimulation()
      ...
      .force('charge', d3.forceManyBody().strength(80).distanceMax(400).distanceMin(80))
